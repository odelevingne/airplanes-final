...
Please create separate files for every class, module and test suite. Commit it to a repo on Github as much as possible.

The submission will be judged on the following criteria:
Tests pass
Tests coverage is good (exceptional really)
